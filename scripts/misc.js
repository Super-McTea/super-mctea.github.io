const miscData = [
    ...
    },
    {
        ...
        info: {
            ...
            data: [
                "<h2>Contributions</h2>",
                "In this project, I was primarily the developer of the gun shooting physics and the target spawning mechanics, the adaptive difficulty formula, as well as the music composer. In addition, I was the contact point between the team and our client at LiminalVR, and was the one who made all of the prototype builds."
            ],
            images: [
                {
